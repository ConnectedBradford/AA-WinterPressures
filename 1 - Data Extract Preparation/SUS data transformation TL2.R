...
## TL - transform SUS (v1) data into something we can model with
...
# 
# data <- dbFetch(result)
data<-readRDS("../Data Extracts/SUSdataRAW.rds")
...
saveRDS(basedata,file="../Data - Generated/SUSv1-basedata.rds")
saveRDS(repeateddata,file="../Data - Generated/SUSv1-repeateddata.rds")
saveRDS(critcaredata,file="../Data - Generated/SUSv1-critcaredata.rds")
## save other bits?
