## Scenario 4 - reduce A&E admission rates
...
## Use probability of 25% - gives a reduction in admission of 20-25 patients per week
...
simmer_wrapper <- function(i) {
  ...
  emergency_patient<- trajectory() %>%
    ...
    branch(function(){
      ...
      if (runif(1)<0.25) return(1) else return(0)
...
saveRDS(resources,"../Model Outputs/4-resources.rds")
saveRDS(attribs,"../Model Outputs/4-attribs.rds")
saveRDS(arrivals,"../Model Outputs/4-arrivals.rds")
