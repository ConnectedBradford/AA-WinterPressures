## Scenario 7c - periop unit

## 8 beds - all extra to hospital
...
#wards$Beds[wards$Ward=="21CC"]<-4 ## temporarily not as we don't have all the patients going to periop yet
...
saveRDS(resources,"../Model Outputs/7c-resources.rds")
saveRDS(attribs,"../Model Outputs/7c-attribs.rds")
saveRDS(arrivals,"../Model Outputs/7c-arrivals.rds")
