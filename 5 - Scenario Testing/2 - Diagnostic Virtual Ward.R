## Scenario 2 - use of DVW
# Use DVW rate of 0.25 - equals approximately doubling DVW use (baseline = about 100 per week)
...
saveRDS(resources,"../Model Outputs/2-resources.rds")
saveRDS(attribs,"../Model Outputs/2-attribs.rds")
saveRDS(arrivals,"../Model Outputs/2-arrivals.rds")
