## Scenario 7b - periop unit

## 6 beds - all extra to hospital
...
wards<-add_row(wards,Ward="Periop",Beds=6)
...
saveRDS(resources,"../Model Outputs/7b-resources.rds")
saveRDS(attribs,"../Model Outputs/7b-attribs.rds")
saveRDS(arrivals,"../Model Outputs/7b-arrivals.rds")
