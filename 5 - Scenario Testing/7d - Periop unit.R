## Scenario 7d - periop unit

## 8 beds - all taken from W21 (4CC, 4normal)
...
wards$Beds[wards$Ward=="21CC"]<-4 ## reduced by 4
...
saveRDS(resources,"../Model Outputs/7d-resources.rds")
saveRDS(attribs,"../Model Outputs/7d-attribs.rds")
saveRDS(arrivals,"../Model Outputs/7d-arrivals.rds")
