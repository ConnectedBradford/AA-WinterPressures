...
## Plan b - spread that surgery over the period instead ie April/May spread over April-July, and October/November spread over August-November
...
saveRDS(resources,"../Model Outputs/6-resources.rds")
saveRDS(attribs,"../Model Outputs/6-attribs.rds")
saveRDS(arrivals,"../Model Outputs/6-arrivals.rds")
